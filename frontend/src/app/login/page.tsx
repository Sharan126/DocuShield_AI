...
import { ShieldAlert, Key, User, Eye, EyeOff, Zap, ShieldCheck, FileCheck, Building2, ArrowRight } from "lucide-react";
...
const DEMO_ACCOUNTS = [
  {
    ...
    desc: "Forensics & Risk Assessment",
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="mt-6 pt-5 border-t border-slate-800/80">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] text-slate-500 uppercase tracking-wider font-mono">1-Click Auto-Fill</span>
                </div>
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          setError("");
                          setMessage(`Filled credentials for ${acc.label}`);
                        }}
                        className="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-950/70 hover:bg-cyan-950/30 border border-slate-800/90 hover:border-accent/50 transition-all text-left group cursor-pointer"
                      >
                        <div className="flex items-center space-x-2.5 min-w-0">
                          <div className={`p-1.5 rounded-lg border text-xs ${acc.badgeColor} shrink-0`}>
                        ...
                        <div className="flex items-center text-[11px] font-semibold text-cyan-400 opacity-70 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all pl-2 shrink-0">
                          <span>Fill</span>
